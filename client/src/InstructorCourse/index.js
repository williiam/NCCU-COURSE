...
import { getCoursesByInstructor } from "../shared/redux/actions/course";
...
const IntegratedCourse = () => {
  ...
  useEffect(() => {
    ...
    if (instructor) {
      dispatch(getCoursesByInstructor({instructor,semester}));
    }
  }, [dispatch,semester]);
        ...
        >
          <Grid item xs={12} sm={12} md={12}>
            <Breadcrumbs aria-label="breadcrumb" className={classes.breadcrumb}>
              ...
              <Typography color="textPrimary">{"教授"}</Typography>
              <Typography color="textPrimary">{departmentZH_TW}</Typography>
              <Typography color="textPrimary">{"課程"}</Typography>
              <div>
                <Button
                  ref={anchorRef}
          ...
          <Grid item xs={12} sm={7} md={10} className={classes.breadcrumb}>
            <Grid
              container
              justify="space-between"
              // alignItems="stretch"
